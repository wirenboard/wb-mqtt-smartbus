...
func init() {
	...
	RegisterMessage(new(*AssignPanelButtonResponse))
	RegisterMessage(new(*SetPanelButtonModes))
	RegisterMessage(new(*SetPanelButtonModesResponse))
	RegisterMessage(new(*ReadMACAddress))
